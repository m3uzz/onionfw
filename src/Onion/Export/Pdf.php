...
class Pdf
{
	...
	protected $PageSizes; // used for pages with non default sizes or
	                      // orientations
	...
	public function isFooter ($h = 0)
	{
		//Debug::display(array('y:'=>$this->y + $h, 'pbt'=>$this->PageBreakTrigger, 'ih'=>$this->InHeader, 'if'=>$this->InFooter, 'apb'=>$this->AutoPageBreak));
		
		if ($this->y + $h > $this->PageBreakTrigger && ! $this->InHeader && ! $this->InFooter && $this->AutoPageBreak)
		{
			//Debug::display('entrei');
			return true;
		}
		else
		{
